...
## Totali
- JS iniziale: **593.4 KB gzip** (target 300 · cap 800)
- CSS: 1.5 KB gzip · GLB: 0 KB (cap 5120)

## FAIL
- nessuno

## Warn
- JS iniziale 593.4 KB gzip > target 300 KB (debito noto: code-split/starter Next — gap analysis)

## File della build
| file | raw | gzip |
|---|---|---|
| index-CvJJN-FZ.js | 1312.8 KB | 406.9 KB gzip |
| index-jPGdU6B0.css | 5.2 KB | 1.5 KB gzip |
